...
Once this step is complete, load the library, and run the `install_keras()` function. This will install a local version of Python, as well as download all the necessary add-ons to build deep learning models:
